...
const PoolTable = ({ table, onAddPlayer, onAddTime, onAddCharge, onCustomCharge, onCheckout, onCheckoutTable, onToggleTimer, onDeleteTable, onUpdateComment, onShowConfirmAction, onSetTableTimer, onRemovePlayer, onMovePlayer }) => {
